...
const i18n = {
  pt: {
    ...
    p1_name: "Chatbot Secretaria Acadêmica (ACADÊMICO)",
    ...
    p5_name: "AgriRSLAB Portal (ACADÊMICO)",
    p5_desc: "Projeto desenvolvido no 1º semestre da FATEC, com foco em solução tecnológica para o agronegócio. Tecnologias: HTML, CSS, JavaScript, Git",
  ...
  en: {
    ...
    p1_name: "Academic Secretary Chatbot (ACADEMIC)",
    ...
    p5_name: "AgriRSLAB Portal (ACADEMIC)",
    p5_desc: "Project developed in the first semester at FATEC, focusing on technological solutions for the agribusiness sector. Technologies: HTML, CSS, JavaScript, Git.",
    p6_name: "Game Rating Platform",
